...
const UserProfile = () => {
    ...
    useEffect( () => {
        ...
        setUserName(user.UserDetailFirstName+" "+user.UserDetailLastName);
        setRoleName(user.RoleName);
    }, []);
    return <React.Fragment>
        <div className="media user-profile mt-2 mb-2">
            <img src={profilePic} className="avatar-sm rounded-circle mr-2" alt="Brain tech Solution" />
            <img src={profilePic} className="avatar-xs rounded-circle mr-2" alt="Brain tech Solution" />

            <div className="media-body">
                <h6 className="pro-user-name mt-0 mb-0">{userName}</h6>
                <span className="pro-user-desc">{roleName}</span>
            </div>
            ...
            <UncontrolledDropdown className="align-self-center profile-dropdown-menu">
                ...
                <DropdownMenu right className="topbar-dropdown-menu profile-dropdown-items">
                    ...
                    <Link to="/account/passwordChange" className="dropdown-item notify-item">
                        <FeatherIcon.Settings className="icon-dual icon-xs mr-2" />
