...
const Tables = () => {
    ...
    const handleSwitch = (id) => {
        history.push("/client/ByLoanTypeIndex/" + id);
    };

    const GetClients = async () => {
        setLoader(true);
        await Axios.get('/client/byLoanType/'+2)
                                ...
                                <Row>
                                    ...
                                    <Link className="btn btn-danger mb-sm-0" to="/client/create" ><i className="uil-plus mr-1"></i>Create</Link>
                                        <div className="btn-group ml-1">
                                            <button type="button" className="btn btn-white" onClick={(e)=>history.push("/client/ByLoanType/HomeLoan")} >Home Loan</button>
                                            <button type="button" className="btn btn-primary" onClick={(e)=>history.push("/client/ByLoanType/CarLoan")} >Car Loan</button>
                                            <button type="button" className="btn btn-white" onClick={(e)=>history.push("/client/ByLoanType/BusinessLoan")} >Business Loan</button>
                                            <button type="button" className="btn btn-white" onClick={(e)=>history.push("/client/ByLoanType/PersonalLoan")} >Personal Loan</button>
                                            <button type="button" className="btn btn-white" onClick={(e)=>history.push("/client/ByLoanType/Refinance")} >Refinance</button>
                                        </div>
                                    </Col>
                                    <Col xl={4}>
                                        <Row>
            ...
            <Row className="page-title">
                <Col md={12}>
                    <PageTitle
                        ...
                        title={'Clients - Approved Loan Stage'}
                    />
                </Col>
            </Row>
