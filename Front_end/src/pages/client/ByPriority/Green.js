...
const Tables = () => {
    ...
    const GetClients = async () => {
        setLoader(true);
        await Axios.get('/client/byLoanType/'+3)
                                ...
                                <Row>
                                    ...
                                    <Link className="btn btn-danger mb-sm-0" to="/client/create" ><i className="uil-plus mr-1"></i>Create</Link>
                                        <div className="btn-group ml-1">
                                            ...
                                            <button type="button" className="btn btn-primary" onClick={(e)=>history.push("/client/ByLoanType/BusinessLoan")} >Business Loan</button>
