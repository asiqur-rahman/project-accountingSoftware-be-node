...
const Tables = () => {
    ...
    const GetClients = async () => {
        setLoader(true);
        await Axios.get('/client/byLoanType/'+1)
                                ...
                                <Row>
                                    {/* <Col xl={9}>
                                        ...
                                        <div className="btn-group ml-1">
                                            <button type="button" className="btn btn-primary" onClick={(e)=>history.push("/client/ByLoanType/HomeLoan")} >Home Loan</button>
                                            <button type="button" className="btn btn-white" onClick={(e)=>history.push("/client/ByLoanType/CarLoan")} >Car Loan</button>
