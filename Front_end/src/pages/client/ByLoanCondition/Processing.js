...
const Tables = () => {
    ...
    const GetClients = async () => {
        setActiveBtn(1);
        setLoader(true);
        await Axios.get('/client/byLoanCondition/'+1)
                                ...
                                <Row>
                                    ...
                                    <Link className="btn btn-danger mb-sm-0" to="/client/create" ><i className="uil-plus mr-1"></i>Create</Link>
                                        <div className="btn-group ml-1">
                                            <Link className="btn btn-primary" to="/client/ByLoanCondition/processing" >Processing</Link>
            ...
            <Row className="page-title">
                <Col md={12}>
                    <PageTitle
                        ...
                        title={'Clients - Processing Loan Stage'}
                    />
                </Col>
            </Row>
