...
const Tables = () => {
    ...
    const GetClients = async () => {
        setActiveBtn(2);
        setLoader(true);
        await Axios.get('/client/byLoanCondition'+2)
                                ...
                                <Row>
                                    ...
                                    <Link className="btn btn-danger mb-sm-0" to="/client/create" ><i className="uil-plus mr-1"></i>Create</Link>
                                        <div className="btn-group ml-1">
                                            {/* <button type="button" className={`btn ${activeBtn==1 ? "btn-primary" : "btn-white"}`} onClick={() => GetClients(1)} >Processing</button>
                                            <button type="button" className={`btn ${activeBtn==2 ? "btn-primary" : "btn-white"}`} onClick={() => GetClients(2)} >Not Processing</button>
                                            <button type="button" className={`btn ${activeBtn==3 ? "btn-primary" : "btn-white"}`} onClick={() => GetClients(3)} >Conditional</button>
                                            <button type="button" className={`btn ${activeBtn==4 ? "btn-primary" : "btn-white"}`} onClick={() => GetClients(4)} >Approved</button>
                                            <button type="button" className={`btn ${activeBtn==5 ? "btn-primary" : "btn-white"}`} onClick={() => GetClients(5)} >Settled</button>
                                            <button type="button" className={`btn ${activeBtn==6 ? "btn-primary" : "btn-white"}`} onClick={() => GetClients(5)} >Settled</button> */}
                                            <Link className="btn btn-white" to="/client/ByLoanCondition/processing" >Processing</Link>
                                            <Link className="btn btn-primary" to="/client/ByLoanCondition/notProcessing" >Not Processing</Link>
                                            <Link className="btn btn-white" to="/client/ByLoanCondition/conditional" >Conditional</Link>
            ...
            <Row className="page-title">
                <Col md={12}>
                    <PageTitle
                        ...
                        title={'Clients - Not Processing Loan Stage'}
                    />
                </Col>
            </Row>
