...
import { Row, Col, Card,InputGroupAddon, CardBody, Label, Input, Button, Progress } from 'reactstrap';
...
const Content = () => {
    ...
    const checkValidations=(stepId)=>{
        if(stepId){
            switch(stepId){
                case 1:{
                    setAllOk(true);
                    if(FirstName===''){
                        showModal({body:"First Name can't be empty."});
                    }
                    else if(LastName===''){
                        showModal({body:"Last Name can't be empty."});
                    }
                    else if(Email===''){
                        showModal({body:"Email can't be empty."});
                    }
                    else if(Phone==='' || Phone.split('_').length>1){
                        showModal({body:"Please enter valid phone number."});
                    }
                    else if(Address===''){
                        showModal({body:"Address can't be empty."});
                    }
                    else if(About===''){
                        showModal({body:"About client can't be empty."});
                    }
                    else{
                        return allOk;
                    }
                ...
                case 2:{
                    ...
                    if(LoanTypeId===0){
                        ...
                        showModal({body:"Loan Amount can't be Zero / empty"});
                    }
                                        ...
                                        <AvForm
                                            ...
                                            <Row>
                                                ...
                                                <Col xl={12}>
                                                    ...
                                                    <Input type="textarea" rows="8" className="form-control" onChange={(e) => { setAbout(e.target.value) }} defaultValue={About} />
                                                    <br/>
                                                </Col>
                                            </Row>
                                                ...
                                                <Col xl={6}>
                                                    <AvGroup>
                                                        ...
                                                        <div className="input-group">
                                                            ...
                                                            <Input placeholder="100000" name="Amount" required value={Amount} onChange={e => setAmount(e.target.value)}/>
                                    ...
                                    render={({ next, previous }) => (
                                        <AvForm
                                            ...
                                            <Row>
                                                ...
                                                <Col xl={6}>
                                                    <div className="form-group">
                                                        ...
                                                        <Input type="date" min={`${new Date().toISOString().substr(0,10)}`} id="date-input" placeholder="date" value={AppDate} onChange={(e) =>{handleDateChange(e.target.value);}} required/>
                                                    </div>
                                                </Col>
                                                <Col xl={6}>
                                            ...
                                            <ul className="list-inline wizard mb-0">
                                                ...
                                                <li className="next list-inline-item float-right" style={{paddingRight:'10px'}}>
                                                    <Button color="secondary" type="submit" onClick={()=>setSkipApp(true)}>
                                                        Skip Appoinment
                                                    </Button>
                                                </li>
                                            </ul>
