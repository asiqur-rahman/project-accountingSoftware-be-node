                                ...
                                <Row>
                                    <Col xl={8}>
                                        ...
                                        <div className="btn-group ml-1">
                                            <button type="button" className={`btn ${activeList ? "btn-primary" : "btn-white"}`}>Active</button>
                                            <button type="button" className={`btn ${activeList ? "btn-white" : "btn-primary"}`}>InActive</button>
                                        </div>
                                    </Col>
                                    <Col xl={4}>
                                        <Row>
