                                    ...
                                    <CardBody className="p-0">
                                        <Row>
                                            <Col md={12} className="p-5 position-relative">
                                                ...
                                                <div className="mx-auto mb-5" style={{display: 'flex',  justifyContent:'center', alignItems:'center'}}>
                                                    <a href="/">
                                                        <img src={logo} alt="Brain tech Solution" height="60" />
                                                        {/* <h3 className="d-inline align-middle ml-1 text-logo">TMB</h3> */}
                                                    </a>
                                                </div>

                                                <h6 className="h5 mb-0 mt-4">Welcome back!</h6>
                                                <p className="text-muted mt-1 mb-4">Enter your username and password to access admin panel.</p>
                                            ...
                                            {/* <Col md={6} className="d-none d-md-inline-block">
                                                <div className="auth-page-sidebar">
                                                    ...
                                                    <div className="auth-user-testimonial"> */}
                                                        ...
                                                        {/* <p className="lead">"Developed By Jm Tech Australia"</p> */}
                                                        {/* <p>Tech partner of JM Tech Australia</p> */}
                                                    {/* </div>
                                                </div>
                                            </Col> */}
                                        </Row>
