    ...
    const handleUpdate=async ()=>{
        if(password || cPassword ){
            if(password!=cPassword){
                ...
                setLoader(true);
                await Axios.patch('/user/withPass/id/'+user.Id,{
                    Username:username,
                    FirstName:firstName,
                    LastName:lastName,
                    Address:address,
                        ...
                        <CardBody>
                            ...
                            <AvForm onValidSubmit={() => {handleUpdate()}}>
                                <Row>
                                    ...
                                    <Col xl={6}>
                                        <AvField name="NewPassword" label="New Password" type="password" onChange={e => setPassword(e.target.value)}/>
                                    </Col>
                                    <Col xl={6}>
                                        <AvField name="ConfirmPassword" label="Confirm New Password" type="password" onChange={e => setcPassword(e.target.value)}/>
                                    </Col>
                                    {/* <Col xl={6}>
                                ...
                                <FormGroup>
                                    <AvInput
                                        ...
                                        type="checkbox"
                                        name="customCheckbox"
                                        label="Yes, I am sure about the updation."
                                        required
                                    />
                                </FormGroup>
