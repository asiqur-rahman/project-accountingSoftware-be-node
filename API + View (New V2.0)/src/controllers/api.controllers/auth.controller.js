        ...
        else
        {
            ...
            if (!isMatch) {
                ...
                const detailsForToken = {
                  ...
                  full_name: `${user['userDetailfirstName']} ${user['userDetaillastName']}`,
                  user_id: user.id.toString(),
                  role_id: user['userDetailrole.id'].toString(),
                  role_code: user['userDetailrole.code'].toString(),
                  role_name: user['userDetailrole.name'].toString(),
