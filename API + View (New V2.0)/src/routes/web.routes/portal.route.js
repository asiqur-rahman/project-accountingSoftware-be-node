...
router.get('/dashboardLTFD', webAuth() , awaitHandlerFactory(portalController.dashboardLTFD));
router.get('/dashboardEAR', webAuth() , awaitHandlerFactory(portalController.dashboardEAR));
router.get('/dashboardApex/:days', webAuth() , awaitHandlerFactory(portalController.dashboardApex));
