...
var transport = nodemailer.createTransport({
    host: config.emailSetting.host,//"mail.chickenman.net.au",
    port: config.emailSetting.port,//465,
    secure: true, // true for 465, false for other ports
    auth: {
      user: config.emailSetting.email,//"no-reply@chickenman.net.au", //example of generated by Mailtrap
      pass: config.emailSetting.password,//"@chicken_man@no-reply" //example of generated by Mailtrap
    },
    tls: {
